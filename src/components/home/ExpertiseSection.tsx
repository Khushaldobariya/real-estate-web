...
<section className="flex flex-col md:flex-row  gap-6  mb-16 ">
      ...
      <div className="flex gap-3 w-full md:w-1/5  ">
        <img src="/assets/image/building.png"  alt="Building" className="w-32 h-4/5 mb-4 object-cover -mt-" />
      ...
      <div className="w-full md:w-4/5 p-6 bg-pink-100  ">
        ...
        <img src="/assets/image/people.png"  alt="Team" className="w-full object-cover" />
      </div>
    </section>
  )
}
