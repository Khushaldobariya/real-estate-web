...
const JourneySection = () => {
  return (
    ...
    //     <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mt-8 text-[#905c87] font-medium ">
    //       {StatsData.map((stat, index) => (
    //         <div className="flex  flex-col items-center">
    //           <span
    //             className={`${stat.size} text-[#905c87]  font-medium   sm:text-lg md:text-xl lg:text-5xl`}
    //           >
    //             {stat.value}
    //           </span>
