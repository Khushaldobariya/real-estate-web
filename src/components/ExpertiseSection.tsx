...
const ExpertiseSection = () => {
  return (
    // <section className="bg-[#ffe9fe]  flex flex-col items-center p-8 md:p-10">
    //   <div className=" max-w-7xl border border-black lg:container mx-auto">
    //     <div className="  w-full flex justify-center  flex-col md:flex-row  items-center">
    //       <div className="w-full md:w-4/5 ">
    //         <h2 className="  text-xl md:text-4xl  text-center text-gray-800 mb-4 font-medium">
    //           Expertise
    //         </h2>
    //       </div>
    //       <div className="h-3/5 ">
