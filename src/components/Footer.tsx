...
const Footer = () => {
  return (
    ...
    //       <h2 className="text-3xl lg:text-5xl tracking-normal font-medium">
    //         Subscribe
    //       </h2>
    ...
    //             Address:
    //           </h3>
    //           <p className="mt-2 text-gray-700 text-base md:text-xl font-medium">
    //             {FooterData.address}
    //           </p>
    //         </div>
    //         <div>
  ...
  >
    <div className="container mx-auto px-4 md:px-8 lg:px-12 grid grid-cols-1 md:grid-cols-2 gap-8">
      <div>
        <h2 className="text-2xl md:text-3xl lg:text-5xl font-medium">
          Join Our Parivaar
        </h2>
      ...
      <div className="md:ml-auto">
        <h2 className="text-2xl md:text-3xl lg:text-5xl tracking-normal font-medium">
          Subscribe
        </h2>
