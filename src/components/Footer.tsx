...
const Footer = () => {
  return (
    ...
    //           className="p-3 w-full rounded-l-lg text-gray-800"
    //         />
    //         <button className="bg-yellow-500 px-6 py-3 rounded-r-lg font-semibold">
    //           SUBSCRIBE
    //         </button>
    //       </div>
    ...
    //       <div className="w-full md:w-1/2 flex gap-6 md:gap-10 justify-end">
    //         <div>
      ...
      <div>
        ...
        <div className="mt-4 flex flex-col sm:flex-row">
          <input
            type="email"
            placeholder="Enter your email"
            className="p-3 w-full rounded-lg text-gray-800 mb-2 sm:mb-0 sm:rounded-l-lg"
          />
          <button className="bg-yellow-500 px-6 py-3 rounded-lg sm:rounded-l-none font-semibold">
            SUBSCRIBE
          </button>
        </div>
        <p className="mt-2 text-gray-200 text-sm">
