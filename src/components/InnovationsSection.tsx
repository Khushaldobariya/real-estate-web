...
// <section className="container  px-0 md:px-0  md:pr-14 flex flex-col gap-x-6  md:flex-row items-center">
...
//   </div>
// 
//   <div className="w-full px-4 md:px-0 md:w-1/2 flex justify-start flex-col gap-7 mt-10 md:mt-2">
...
//               <h2 className="text-xl md:text-2xl text-gray-900">{service.title}</h2>
...
<section className="max-w-screen-7xl  mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-stretch gap-10 md:gap-16">
  {/* Image Section */}
  <div className="w-full md:w-1/2 flex justify-center md:justify-end">
    <img 
      className="object-cover w-full h-auto md:h-full     lg:w-[616px] lg:h-[800px]" 
      src="/assets/images/innovations.webp"  
      alt="Innovations"
      draggable="false" 
    />
  ...
  <div className="w-full md:w-1/2 flex flex-col justify-center gap-6 sm:gap-8 md:gap-10 mt-6 sm:mt-8 md:mt-0">
    ...
    <p className="text-sm sm:text-base md:text-lg max-w-prose text-center md:text-left">
      We prioritize developing innovative solutions that directly address their needs. Our dedicated team is driven by a customer-centric approach, ensuring every product and service we create enhances customer experiences and delivers tangible results.
    </p>
        ...
        <div key={index} className="flex items-start gap-4 sm:gap-6">
          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="space-y-3 sm:space-y-5">
              <h3 className="text-lg sm:text-xl md:text-2xl text-gray-900">{service.title}</h3>
